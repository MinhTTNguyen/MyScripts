...
print Out "#Seq_id\tPFAM_module\tPFAM_module (evalue, domain_start, domain_end)\n";
while (<In>)
{
	if($_!~/^\#/)
	{
		$_=~s/\s*$//;#Anamu_P05526	PF01193 (1.50E-17 , 29 , 261) | PF01000 (3.40E-36 ,59 , 177)
		my @cols=split(/\t/,$_);
		my $id=$cols[0];
		my $PFAM=$cols[1];
