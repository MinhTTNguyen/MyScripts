...
print header,
	  ...
	  h1({-style=>'Background: PaleTurquoise;height:30px;',-align => "left"}, font({-size => 3, -color => "black", -face => "Arial"},"Principle Component Analysis (PCA): Select transcriptome datasets ($selected_organism)")),
	  a({href=>"Automatic_RNA_seq_analysis_tool_home.pl"},"Back to home page"),
	  h2(font({-face => "Arial", -size => 3},"Select conditions:"));


################################################################ Filter sample table ################################################################
print start_form (-name => "Filter info table", -method => "post", -action => "Automatic_RNA_seq_analysis_tool_filter_sample_table_PCAplot.pl"),
	  br,"&nbsp",
...
################################################################ Sort sample table ################################################################
print start_form (-name => "Sort sample table", -method => "post", -action => "Automatic_RNA_seq_analysis_tool_sort_sample_table_PCAplot.pl"),
	  br,"&nbsp",
...
################################################################ Create PCA plot form ################################################################
print start_form (-name => "Select conditions", -method => "post", -action => "Automatic_RNA_seq_analysis_tool_create_PCAplot_bridge.pl"),
      font({-face => "Arial", -size => 2},
      radio_group(-name =>"Select_Deselect_all", -value =>"Select All", -onClick =>"Select_all_checkboxes(this,'Conditions')"),
      "&nbsp&nbsp&nbsp&nbsp&nbsp",
      radio_group(-name =>"Select_Deselect_all", -value =>"Deselect All", -onClick =>"Deselect_all_checkboxes(this,'Conditions')")),br,br;  
...
print hidden(-name => "file_name", -value => "$transcriptome_data_file"),
      hidden(-name => "Organism", -value => "$selected_organism"),
      br, font({-color=>"red"},em("*** For a good result, please select less than 12 samples")),
      br, br, submit(-name => "Create PCA plot"),
      end_form;
################################################################ Create PCA plot form ################################################################
